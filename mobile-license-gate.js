(() => {
  ...
  const APP_SCRIPTS = ['mobile-chrome-shim.js?rev=345','assets/dashboard-mobile.js?rev=345','mobile-data-bridge.js?rev=345','mobile-app-shell.js?rev=345','mobile-remote.js?rev=345'];
  ...
  async function api(path, body, timeoutMs=25000) {
    ...
    try {
      const response=await fetch(API_BASE+path,{
        ...
        body:JSON.stringify({...body,deviceType:'MOBILE',clientType:'MOBILE',mobilePlatform:platformName(),mobileVersion:'1.0.104',remoteRevision:'REV345'})
      });
