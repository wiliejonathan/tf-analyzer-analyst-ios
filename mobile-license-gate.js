(() => {
  ...
  const APP_SCRIPTS = ['mobile-chrome-shim.js?rev=343','assets/dashboard-mobile.js?rev=343','mobile-data-bridge.js?rev=343','mobile-app-shell.js?rev=343','mobile-remote.js?rev=343'];
  ...
  async function api(path, body, timeoutMs=25000) {
    ...
    try {
      const response=await fetch(API_BASE+path,{
        ...
        body:JSON.stringify({...body,deviceType:'MOBILE',clientType:'MOBILE',mobilePlatform:platformName(),mobileVersion:'1.0.103',remoteRevision:'REV343'})
      });
