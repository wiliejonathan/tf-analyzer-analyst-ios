const CACHE='tf-analyzer-analyst-mobile-v146-rev351-silent-license-recheck';
const ASSETS=[
  './assets/dashboard-mobile.js?rev=351',
  './assets/dashboard-original.css?rev=351',
  './icon32.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png',
  ...
  './mobile-force-update.js?rev=351',
  './mobile-license-gate.js?rev=351',
  './mobile-import-fix-v30.js?rev=351',
  './mobile-overrides.css?rev=351'
];
...
// REV351: remember Email+Token only; verify server before dashboard; live revocation; fresh dashboard/import data every launch.
