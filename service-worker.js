const CACHE='tf-analyzer-analyst-mobile-v143-rev347-touch-tooltip-offset';
const ASSETS=[
  './assets/dashboard-mobile.js?rev=347',
  './assets/dashboard-original.css?rev=347',
  './icon32.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png',
  ...
  './mobile-app-shell.js?rev=347',
  './mobile-remote.js?rev=347',
  './mobile-chrome-shim.js?rev=347',
  './mobile-data-bridge.js?rev=347',
  './mobile-force-update.js?rev=347',
  './mobile-license-gate.js?rev=347',
  './mobile-import-fix-v30.js?rev=347',
  './mobile-overrides.css?rev=347'
];
